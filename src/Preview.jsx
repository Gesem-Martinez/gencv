export default function Preview({generalInfoStates={}, educationInfoStatesArr=[], experienceInfoStatesArr=[]}) {
  return (
      ...
      <div className="content-wrapper">
        <div className="preview-sidebar">
          <div className="preview-summary preview-sidebar-info">
            ...
            <p className="preview-sidebar-body">{generalInfoStates.summary}</p>
          </div>
          <div className="preview-location preview-sidebar-info">
            <p className="preview-sidebar-header">Location</p>
            <p className="preview-sidebar-body">{generalInfoStates.location}</p>
          </div>
            ...
            {educationInfoStatesArr.map((educationObj) => {
              return (
                <div key={educationObj.id} className="preview-section-item">
                  ...
                  <p className="preview-section-info">{educationObj.endDate}</p>
                </div>
              );
            })}
          </div>
